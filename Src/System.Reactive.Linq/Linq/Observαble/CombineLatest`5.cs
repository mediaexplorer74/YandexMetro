...
// Type: System.Reactive.Linq.Observαble.CombineLatest`5
...
namespace System.Reactive.Linq.Observαble
{
  internal class CombineLatest<T1, T2, T3, T4, TResult> : Producer<TResult>
  {
    ...
    private class _ : CombineLatestSink<TResult>
    {
      ...
      protected override TResult GetResult() => this._parent._resultSelector(this._observer1.Value, this._observer2.Value, this._observer3.Value, this._observer4.Value);
    }
  }
}
