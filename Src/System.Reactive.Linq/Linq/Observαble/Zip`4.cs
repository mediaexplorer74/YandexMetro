...
// Type: System.Reactive.Linq.Observαble.Zip`4
...
namespace System.Reactive.Linq.Observαble
{
  internal class Zip<T1, T2, T3, TResult> : Producer<TResult>
  {
    ...
    private class _ : ZipSink<TResult>
    {
      ...
      protected override TResult GetResult() => this._parent._resultSelector(this._observer1.Values.Dequeue(), this._observer2.Values.Dequeue(), this._observer3.Values.Dequeue());
    }
  }
}
