...
// Type: System.Reactive.Linq.Observαble.Max`1
...
namespace System.Reactive.Linq.Observαble
{
  internal class Max<TSource> : Producer<TSource>
  {
      ...
      Action<IDisposable> setSink)
    {
      ...
      {
        Max<TSource>._ observer1 = new Max<TSource>._(this, observer, cancel);
        setSink((IDisposable) observer1);
        return this._source.SubscribeSafe<TSource>((IObserver<TSource>) observer1);
      }
      Max<TSource>.δ observer2 = new Max<TSource>.δ(this, observer, cancel);
