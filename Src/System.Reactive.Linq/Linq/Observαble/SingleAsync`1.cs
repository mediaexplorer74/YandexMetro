...
// Type: System.Reactive.Linq.Observαble.SingleAsync`1
...
namespace System.Reactive.Linq.Observαble
{
  internal class SingleAsync<TSource> : Producer<TSource>
  {
      ...
      Action<IDisposable> setSink)
    {
      ...
      {
        SingleAsync<TSource>.π observer1 = new SingleAsync<TSource>.π(this, observer, cancel);
        setSink((IDisposable) observer1);
        return this._source.SubscribeSafe<TSource>((IObserver<TSource>) observer1);
      }
      SingleAsync<TSource>._ observer2 = new SingleAsync<TSource>._(this, observer, cancel);
