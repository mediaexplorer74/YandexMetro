...
// Type: Yandex.App.Information.AppList.ProductionAppListUrlProvider
...
{
  public class ProductionAppListUrlProvider : IAppListUrlProvider
  {
    public string GetBaseUrl() => "http://www.yandex.ru/apps/xml";
  }
}
