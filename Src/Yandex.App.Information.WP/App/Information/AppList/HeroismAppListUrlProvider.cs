...
// Type: Yandex.App.Information.AppList.HeroismAppListUrlProvider
...
{
  public class HeroismAppListUrlProvider : IAppListUrlProvider
  {
    public string GetBaseUrl() => "http://www-dev36.wdevx.yandex.ru/apps/xml";
  }
}
