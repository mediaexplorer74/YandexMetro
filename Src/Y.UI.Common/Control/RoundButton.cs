...
// Type: Y.UI.Common.Control.RoundButton
...
{
  public class RoundButton : InvertButton
  {
    public RoundButton() => ((System.Windows.Controls.Control) this).DefaultStyleKey = (object) typeof (RoundButton);
  }
}
