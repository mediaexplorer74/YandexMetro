...
// Type: Y.UI.Common.Behaviors.ExecuteCommandOnEnterAutoComplete
...
{
  public class ExecuteCommandOnEnterAutoComplete : Behavior<AutoCompleteBox>
  {
    public static readonly DependencyProperty CommandProperty = DependencyProperty.Register(nameof (Command), typeof (ICommand), typeof (ExecuteCommandOnEnterAutoComplete), new PropertyMetadata((PropertyChangedCallback) null));

    public ICommand Command
    {
      get => (ICommand) this.GetValue(ExecuteCommandOnEnterAutoComplete.CommandProperty);
      set => this.SetValue(ExecuteCommandOnEnterAutoComplete.CommandProperty, (object) value);
    }
