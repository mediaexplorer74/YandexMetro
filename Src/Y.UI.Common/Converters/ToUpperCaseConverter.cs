...
// Type: Y.UI.Common.Converters.ToUpperCaseConverter
...
namespace Y.UI.Common.Converters
{
  ...
  {
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => value == null ? (object) null : (object) value.ToString().ToUpper();
