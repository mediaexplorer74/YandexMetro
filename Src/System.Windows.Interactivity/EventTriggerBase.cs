      ...
      get
      {
        ...
        else if (this.IsSourceNameSet)
        {
          ...
          if (source != null && !this.SourceTypeConstraint.IsAssignableFrom(source.GetType()))
            throw new InvalidOperationException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, ExceptionStringTable.RetargetedTypeConstraintViolatedExceptionMessage, (object) ((object) this).GetType().Name, (object) source.GetType(), (object) this.SourceTypeConstraint, (object) nameof (Source)));
        }
        return source;
      }
    }
...
label_7:
    ...
    private void UnregisterEventImpl(object obj, string eventName)
    {
      ...
      if ((object) this.eventHandlerMethodInfo == null)
        return;
