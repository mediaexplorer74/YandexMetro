...
// Type: Yandex.Maps.Repository.Dto.StopMetaData
...
namespace Yandex.Maps.Repository.Dto
{
  ...
  public class StopMetaData
  {
    ...
    [XmlElement("Transport", Namespace = "http://maps.yandex.ru/ymaps/masstransit/1.x")]
    public TransportDto[] Transports { get; set; }
  }
}
