...
// Type: schemepackSchemeTransfersTransferStation
...
[DebuggerStepThrough]
public class schemepackSchemeTransfersTransferStation
{
  ...
  public override string ToString() => this.valueField.ToString();
}
