...
namespace Ionic.Zlib
{
  public class GZipStream : Stream
  {
    ...
    internal static System.Text.Encoding Iso8859Dash1;
    ...
    public GZipStream(Stream stream, CompressionMode mode, CompressionLevel level, bool leaveOpen)
    {
      ...
      if (GZipStream.Iso8859Dash1 != null)
        return;
      try
      {
        GZipStream.Iso8859Dash1 = System.Text.Encoding.GetEncoding("iso-8859-1");
      }
      catch
      {
        GZipStream.Iso8859Dash1 = (System.Text.Encoding) new Iso8859Dash1Encoding();
      }
    }
